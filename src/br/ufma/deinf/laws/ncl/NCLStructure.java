...
public class NCLStructure {
	...
	private NCLStructure() {
		...
		att("simpleCondition", "min", false, DataType.MIN_QUANTITY);
		att("simpleCondition", "max", false, DataType.MAX_QUANTITY);
		...
		att("simpleAction", "min", false, DataType.MIN_QUANTITY);
		att("simpleAction", "max", false, DataType.MAX_QUANTITY);
		...
		ref("port", "interface", "property", "name"); //D̼vida! Verificar isto!
